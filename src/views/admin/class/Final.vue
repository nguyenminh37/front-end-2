<template>
  ...
  <div v-else class="w-full" >
    <FinalExist v-if="exam.examStudentResponses && exam.date && exam.examinationType && exam.examinationId"
      :exam-responses="exam"
      :class-id="classId"
      :open="open"
      @update:open="emit('update:open', $event)"
...
import FinalNotExist from "./FinalNotExist.vue";
import FinalExist from "./FinalExist.vue";
